...
final class SecondPageView: BaseView<SecondPageViewModel, SecondPageOutputEvents> {
    ...
    override func style() {
        ...
        self.pokemonImageView.image = UIImage(named: "largePokemon")
...
extension SecondPageView {
    ...
    private func titleLabelStyle() {
        self.titleLabel.text = "Find out about the abilities"
